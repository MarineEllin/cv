    ...
    <div className={`${styles.timelineContainer}`}>
      <VerticalTimeline>
        ...
        >
          ...
          <p>
            Développement et implémentation de nouvelles features, en
            particulier un système de gestion multi-langues.
          </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
          ...
          <div className={styles.trainingDetails}>
            <details className={styles.details}>
              ...
              <ul>
                ...
                <li>Utilisation de Netlify et déploiement de mon site CV.</li>
                <li>
                  Réalisation de 4 projets : le site web d'un café, le site web
                  d'une agence immobilière, une reproduction d'une page web
                  complexe avec utilisation des grilles et boites flexibles et
                  la création de ce site CV.
                </li>
              </ul>
            </details>
            <details className={styles.details}>
            ...
            <details className={styles.details}>
              ...
              <ul>
                ...
                <li>Réalisation d'un projet complet de livre de recettes.</li>
              </ul>
            </details>
            <details className={styles.details}>
              <summary>Git</summary>
              <ul>
                <li>
                  ...
                  l'index, création des sauvegardes et suppression de fichiers
                  ou dossiers.
                </li>
        ...
        >
          ...
          <p>
            Audit des systèmes de santé et de sécurité au travail des
            entreprises.
          </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
